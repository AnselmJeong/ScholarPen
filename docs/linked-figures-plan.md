...
- Always expose file selection/relink and Reload. Missing or unreadable images show their path and a recovery message instead of an empty rectangle. Relinking preserves captions, identifiers, numbering and layout.
